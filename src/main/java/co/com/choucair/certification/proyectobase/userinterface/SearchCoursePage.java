...
public class SearchCoursePage extends PageObject{
    ...
    public static final Target BUTTON_GO = Target.the("Da clic para buscar el curso").located(By.id("//button[@class='btn btn-secondary']"));
    public static final Target SELECT_COURSE = Target.the("Da clici para buscar el curso").located(By.xpath("//h4[contains(text(),'Recursos Automatización Bancolombia')]"));
